...
LOG_DIR="$LOG_ROOT/simpler_env_mc_data_dec28"  # SAME DIRECTORY as Set 1 (10 MC passes)
...
echo "=========================================="
echo "PutSpoon MC data collection SET 2 COMPLETED"
