...
# BATCH 2: Complete episodes 39-49 for WidowX non-MC baseline
...
do CUDA_VISIBLE_DEVICES=${gpu_id} python simpler_env/main_inference.py --policy-model ${policy_model} --ckpt-path ${ckpt_path} \
  ...
  --robot-init-x ${robot_init_x} ${robot_init_x} 1 --robot-init-y ${robot_init_y} ${robot_init_y} 1 --obj-variation-mode episode --obj-episode-range 39 50 \
...
echo "====================================="
echo "BATCH 2 COMPLETED: Episodes 39-49"
