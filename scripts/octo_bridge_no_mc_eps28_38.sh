...
# BATCH 1: Complete episodes 28-38 for WidowX non-MC baseline
# 11 episodes × 3 seeds × 4 tasks = 132 episodes
...
# Scene 1: bridge_table_1_v1 (PutCarrot, PutSpoon, StackCube)
...
do CUDA_VISIBLE_DEVICES=${gpu_id} python simpler_env/main_inference.py --policy-model ${policy_model} --ckpt-path ${ckpt_path} \
  ...
  --robot-init-x ${robot_init_x} ${robot_init_x} 1 --robot-init-y ${robot_init_y} ${robot_init_y} 1 --obj-variation-mode episode --obj-episode-range 28 39 \
...
# Scene 2: bridge_table_1_v2 (PutEggplant)
...
echo "====================================="
echo "BATCH 1 COMPLETED: Episodes 28-38"
echo "Total episodes: 11 × 3 seeds × 4 tasks = 132 episodes"
echo "====================================="
