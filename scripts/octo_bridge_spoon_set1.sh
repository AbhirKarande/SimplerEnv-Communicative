...
echo "=========================================="
echo "MC DATA COLLECTION: PutSpoon SET 1 (Episodes 0-27)"
echo "MC Passes: ${MC_PASSES}"
echo "Samples per inference: ${SAMPLES_PER_INFERENCE}"
echo "Experimental setup: ${EXP_SETUP}"
echo "=========================================="

# Scene 3: bridge_table_1_v3 (PutSpoon)
scene_name=bridge_table_1_v3
...
echo "=========================================="
echo "PutSpoon MC data collection SET 1 COMPLETED"
